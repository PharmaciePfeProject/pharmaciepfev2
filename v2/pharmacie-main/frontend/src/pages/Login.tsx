        ...
        <div className="hidden flex-col justify-between rounded-[32px] border border-white/70 bg-white/80 p-10 shadow-[0_30px_80px_rgba(15,23,42,0.08)] backdrop-blur lg:flex">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="mt-2 text-3xl font-semibold text-foreground">Plateforme Pharmacie & Aide à la décision</h1>
            </div>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                ["Ordonnances", "Manage prescriptions, distributions, and medical workflows."],
